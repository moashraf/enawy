...
$factory->define(App\Models\slider_en::class, function (Faker $faker) {
     return [
	        'id_sliders' =>  'id_sliders'
			//function(){ return factory('App\Models\NEWS'  )->create()->id; },
        'title' => $faker->name,
...
$factory->define(App\Models\slider_ar::class, function (Faker $faker) {
     return [
	        'id_sliders' =>  'id_sliders'
			//function(){ return factory('App\Models\NEWS'  )->create()->id; },
        'title' => $faker->name,
